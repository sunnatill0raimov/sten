...
const SolveSten: React.FC = () => {
    ...
    const loadStenMetadata = async () => {
      try {
        ...
        if (!metadataResponse.exists) {
          ...
          typeof metadataResponse.viewsRemaining === "number" &&
          metadataResponse.viewsRemaining <= 0
        ) {
  ...
  const handleAccessSten = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage =
        err instanceof Error ? err.message : "Failed to access STEN";
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2h-2M7 3h10a2 2 0 012 2v16a2 2 0 01-2 2H7a2 2 0 01-2-2V5a2 2 0 012-2z"
                      />
                    </svg>
                    <div>
